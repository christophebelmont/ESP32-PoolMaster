...
MAKE_WORD_TRANSLATION(NXT_REGULATION_SWG_TITLE, "SWG Mode", "Mode Electrolyse", "", "")
...
MAKE_WORD_TRANSLATION(NXT_ELECTROMODE_TITLE, "SWG Regulation", "Régulation Electrolyse", "", "")
MAKE_WORD_TRANSLATION(NXT_ELECTROMODE_MODE, "SWG RunMode", "Mode Electrolyse", "", "")
MAKE_WORD_TRANSLATION(NXT_ELECTROMODE_UPTIME, "SWG RunTime", "Durée Electrolyse", "", "")
MAKE_WORD_TRANSLATION(NXT_ELECTROMODE_ON, "ADJUST", "AJUSTÉE", "", "")
MAKE_WORD_TRANSLATION(NXT_ELECTROMODE_OFF, "FIXED", "FIXÉE", "", "")
...
MAKE_WORD_TRANSLATION(NXT_MENU_LEFT4,  "  Relays", "  Relais", "  ", "  ")
MAKE_WORD_TRANSLATION(NXT_MENU_LEFT5,  "  System", "  Système", "  ", "  ")
...
MAKE_WORD_TRANSLATION(NXT_SUBMENU30, "SWG Mode", "Mode Electrolyse", "", "")
MAKE_WORD_TRANSLATION(NXT_SUBMENU31, "SWG Regulation", "Régul. Electrolyse", "", "")
